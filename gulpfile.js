...
gulp.task('scripts', function() {
    return gulp.src([
        ...
        'app/libs/bootstrap-4.1.0/assets/js/vendor/popper.min.js',
        'app/libs/bootstrap-4.1.0/dist/js/bootstrap.min.js',
        'app/libs/owl.carousel/dist/owl.carousel.js',
        'app/libs/particlesjs/dist/particles.min.js',
        'app/libs/shuffle/shufflejs/dist/shuffle.min.js',
        'app/libs/shuffle/shuffle.min.js',
